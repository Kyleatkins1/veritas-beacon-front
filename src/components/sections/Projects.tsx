    ...
    <section id="projects" className="section-padding bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-veritas-primary mb-4">Projects in Development</h2>
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Discover our innovative healthcare and safety-focused platforms currently in development, 
            designed to revolutionize how organizations manage data, risk, and safety.
          </p>
        </div>
